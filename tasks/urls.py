...
from tasks.views import manager_dashboard,employee_dashboard,view_task,update_task,delete_task,task_details,dashboard,Greetings,HiGreetings,CreateTask,ViewProject,TaskDetail,UpdateTask
